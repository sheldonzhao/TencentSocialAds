...
X_train = sparse.hstack((X_train, dfTrain['download_num'].values.reshape(-1, 1)))
X_train = sparse.hstack((X_train, dfTrain['avg_cvr'].values.reshape(-1, 1)))
X_test = sparse.hstack((X_test, dfTest['download_num'].values.reshape(-1, 1)))
X_test = sparse.hstack((X_test, dfTest['avg_cvr'].values.reshape(-1, 1)))
...
df.to_csv(f_pack.file_output, index=False)
